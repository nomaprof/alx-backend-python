#!/usr/bin/env python3
"""
Unit test Test client to test program for correct functionality
"""
...
class TestGithubOrgClient(unittest.TestCase):
    """
    Test github org client classs for unittest
    """
    ...
    def test_org(self, data, mock):
        """
        self descriptive testing module
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """Integration test for correct program"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_public_repos(self):
        """test public repos in the database"""

    def test_public_repos_with_license(self):
        """test public with license in the data from the database"""
